...
public class UpComingFragment extends Fragment {
    private ArrayList<UpComing> listItems = new ArrayList<>();
    private Disposable disposable;
    static final String TAG= "UpComing";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRecyclerView = (RecyclerView) view.findViewById(R.id.up_coming_list);
    ...
    public void getData(){
        ...
        Rx2AndroidNetworking.get("https://api.themoviedb.org/3/movie/upcoming?api_key=876274721e9978d826977226dc1fb9ba&language=en-US")
                .build()
                .getStringObservable()
                ...
                .subscribe(new Observer<String>() {
                    ...
                    public void onNext(String s) {
                        try{
                            ...
                            mAdapter.setListUpComing(listItems);
